...
4. **Tối giản (Minimalist):** Mã nguồn phải sạch sẽ, tinh gọn. Sử dụng ghi chú ngắn gọn bằng dấu `#` trên đầu mỗi hàm. TUYỆT ĐỐI KHÔNG sử dụng các dải phân cách cồng kềnh như `# ========` để tránh làm rối mắt, đặc biệt là trong môi trường Jupyter Notebook.
