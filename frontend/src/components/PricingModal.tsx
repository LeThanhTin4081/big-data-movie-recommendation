...
const PLANS = [
  {
    ...
    badge: null,
    features: [
      { text: "Xem phim chất lượng chuẩn (SD)", included: true },
      { text: "Kho phim cơ bản (Kèm quảng cáo)", included: true },
      { text: "Lưu danh sách phim yêu thích", included: false },
      { text: "Xem Full HD 1080p mượt mà", included: false },
      { text: "Tải phim xem ngoại tuyến (Offline)", included: false },
      { text: "Âm thanh vòm Dolby Atmos & 4K", included: false },
    ],
  ...
  },
  {
    ...
    features: [
      ...
      { text: "Lưu danh sách phim yêu thích", included: true },
      { text: "Xem Full HD 1080p siêu nét", included: true },
      { text: "Không quảng cáo làm phiền", included: true },
      { text: "Tải phim xem ngoại tuyến (Offline)", included: false },
      { text: "Âm thanh vòm Dolby Atmos & 4K", included: false },
    ],
  ...
  },
  {
    ...
    features: [
      { text: "Tất cả tính năng của gói Pro", included: true },
      { text: "Tải phim xem ngoại tuyến (Offline)", included: true },
      { text: "Chất lượng 4K Ultra HD & HDR", included: true },
      { text: "Âm thanh vòm đỉnh cao Dolby Atmos", included: true },
      { text: "Xem cùng lúc trên 4 thiết bị", included: true },
